...
mkdir /home/$USER/mcServer
mkdir /home/$USER/plugins
mkdir /home/$USER/mcServer-backup3

sudo docker run -d -v /home/$USER/plugins:/data/plugins -v /home/$USER/mcServer:/data --name mcServer -e MOTD='David es joto automatizado' -e MODE=survival -e PVP=true -e VERSION=1.16.5 -e EULA=TRUE -e ENABLE_RCON=TRUE -e RCON_PASSWORD=davidjoto2806 -e REPLACE_ENV_VARIABLES=TRUE -e TYPE=BUKKIT -e PLUGINS_SYNC_UPDATE=false -p 25565:25565 -p 25575:25575 itzg/minecraft-server
